...
public class UserCenterFavoritesFragment extends UserBaseFragment<TopicRecycleAdapter> {

    public static UserCenterFavoritesFragment newInstance(User user) {
        Bundle args = new Bundle();
        args.putParcelable(EXTRA_USER, user);
        UserCenterFavoritesFragment fragment = new UserCenterFavoritesFragment();
    ...
    public void sendRequest() {
        new UserRequest().getFavorites(mUser.login, mPage.current(), Page.LIMIT, new Callback<TopicArrayResponse>() {
            @Override
